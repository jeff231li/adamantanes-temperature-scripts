...
The change in heat capacity upon binding $\Delta C_{p,b,i}$ is then obtained by subtracting the grid of the free solutes from the identically aligned bound complex
